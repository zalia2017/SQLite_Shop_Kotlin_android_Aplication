    ...
    fun register(){
        ...
        requestCall.enqueue(object : Callback<DefaultResponse>{
            override fun onFailure(call: Call<DefaultResponse>, t: Throwable) {
                Toast.makeText(baseContext, "Proses Register gagal "+t.toString(), Toast.LENGTH_SHORT).show()
            }
            ...
            override fun onResponse(
                ...
                if(response.isSuccessful){
                    Toast.makeText(this@SignUp, "Proses Register berhasil", Toast.LENGTH_SHORT).show()
                    Log.d("log", response.body()?.success.toString())
                    val intent = Intent(this@SignUp, MainActivity::class.java)
                    startActivity(intent)
                }else{
                    Toast.makeText(this@SignUp, "Proses Register Gagal", Toast.LENGTH_SHORT).show()
                }
            }
